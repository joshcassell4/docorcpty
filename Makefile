...
# Quick Start
quickstart: init-config ## Quick start for new developers (containerized)
	@echo -e "${GREEN}========================================${NC}"
	@echo -e "${GREEN}Container Terminal Orchestrator is ready!${NC}"
	@echo -e "${GREEN}========================================${NC}"
	@echo -e ""
	@echo -e "${BLUE}Recommended: Use containerized development${NC}"
	@echo -e "  ${YELLOW}make docker-dev${NC}    - Start containerized dev environment"
	@echo -e "  ${YELLOW}make docker-dev-shell${NC} - Access container shell"
	@echo -e ""
	@echo -e "${BLUE}Alternative: Local development${NC}"
	@echo -e "  ${YELLOW}make setup${NC}         - Install local dependencies"
	@echo -e "  ${YELLOW}make dev${NC}           - Start in development mode"
	@echo -e ""
	@echo -e "${BLUE}Production deployment:${NC}"
	@echo -e "  ${YELLOW}make docker-build${NC}  - Build production images"
	@echo -e "  ${YELLOW}make docker-up${NC}     - Start production containers"
	@echo -e ""
	@echo -e "To run tests:"
	@echo -e "  ${YELLOW}make test${NC}          - Run all tests (local)"
	@echo -e "  ${YELLOW}make docker-dev-shell${NC} then ${YELLOW}pytest${NC} - Run tests in container"
	@echo -e ""
	@echo -e "For more commands: ${YELLOW}make help${NC}"
	@echo -e "For detailed setup: See SETUP.md and DOCKER_DEV.md"